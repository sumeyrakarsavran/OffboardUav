...
class Controller:
    ...
    def __init__(self):
        ...
        self.local_pos = Point(47.397742, 8.5455936, 3.0)

        # initial values for setpoints
        self.sp.position.x = 47.397742
        self.sp.position.y = 8.5455936
    ...
    ## Update setpoint message    	sp_pub.publish(cnt.sp)
    def updateSp(self):
        self.sp.position.x = self.local_pos.x
        self.sp.position.y = self.local_pos.y

    def x_dir(self,distance):
	global latitude
	global longitude
	print("going to......")
	cnt = Controller()
    	self.sp.velocity.x=2
	while not rospy.is_shutdown():
		print("going to position")
		haversine_distance = cnt.haversine()
